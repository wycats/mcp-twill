...
Twill's acceptance suite does not depend on the VBL crate or a sibling checkout. The released-observation bundle lives at `crates/mcp-twill/tests/fixtures/vbl/v0.4.8/` and is pinned to VBL tag `v0.4.8`, peeled commit `3d2ffc135491263a15bd2dc6c8392f615f8958ce`. It contains these files:
