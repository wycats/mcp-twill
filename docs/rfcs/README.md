...
behavior changes. The locked `2026-07-28-RC` commit is implementation authority;
the final tag peel is a provenance-only update when its normative inputs are
